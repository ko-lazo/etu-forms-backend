...
import { createFormImportModule } from "@/modules/form/form-import.module.js";
...
class AppContainer {
  ...
  public formImport!: ReturnType<typeof createFormImportModule>;
  ...
  public init(): void {
    ...
    this.formImport = createFormImportModule({
      jobService: this.job.service,
      jobResultWriter: this.job.repository,
    });
