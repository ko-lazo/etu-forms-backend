...
export function createFormService(repository: FormRepository) {
   ...
   */
  async function publish(form: Form, date: Date): Promise<Form> {
    if (!canPublish(form)) {
   ...
   */
  async function unpublish(form: Form): Promise<Form> {
   ...
   */
  async function archive(form: Form, date: Date): Promise<Form> {
    if (!canArchive(form)) {
   ...
   */
  async function unarchive(form: Form): Promise<Form> {
